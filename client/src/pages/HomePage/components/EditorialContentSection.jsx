...
export default function EditorialContentSection() {
  return (
    <div className="relative w-full h-[500px] rounded-2xl overflow-hidden flex items-center justify-center text-center p-12">
      <div
        role="img"
        aria-label="Artisan crafting furniture by hand"
      ...
      <div className="relative z-10 max-w-2xl text-white">
        ...
        <Link
          ...
          className="bg-white text-primary px-8 py-4 rounded-full font-label-md text-label-md hover:shadow-lg transition-all active:scale-95 inline-block"
          onClick={() => {
